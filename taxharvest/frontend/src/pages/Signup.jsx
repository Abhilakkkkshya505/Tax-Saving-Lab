  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-th-bg relative overflow-hidden">
      ...
      >
        ...
        <h1 className="font-display text-xl font-semibold mb-1 text-center">Create your account</h1>
        <p className="text-sm text-th-text-muted text-center mb-6">Start optimizing your tax position</p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs text-th-text-muted mb-1.5 block">Full name</label>
            <input
              type="text"
              value={fullName}
        ...
        <p className="text-sm text-th-text-muted text-center mt-6">
          ...
          <Link to="/login" className="text-th-blue-bright hover:underline">
            Sign in
          </Link>
        </p>
      </motion.div>
